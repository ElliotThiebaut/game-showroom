...
export const useGamesStore = defineStore("games", {
    ...
    actions: {
        ...
        async updateGame(id, gameData) {
            ...
            try {
                const response = await axios.put(`${import.meta.env.VITE_API_URL}/game/${id}`, gameData, {
                    headers: {
                        Authorization: `KEY ${logicStore.key}`,
                    },
                });
        ...
        async addGame(gameData) {
            ...
            try {
                const response = await axios.post(`${import.meta.env.VITE_API_URL}/game/`, gameData, {
                    headers: {
                        Authorization: `KEY ${logicStore.key}`,
                    },
                });
        ...
        async deleteGame(id) {
            ...
            try {
                const response = await axios.delete(`${import.meta.env.VITE_API_URL}/game/${id}`, {
                    headers: {
                        Authorization: `KEY ${logicStore.key}`,
                    },
                });
        ...
        async updateGameCover(id, file) {
            ...
            try {
                const response = await axios.post(`${import.meta.env.VITE_API_URL}/cover/${id}`, coverFormData, {
                    headers: {
                        Authorization: `KEY ${logicStore.key}`,
        ...
        async updateGameVideo(id, file) {
            ...
            try {
                const response = await axios.post(`${import.meta.env.VITE_API_URL}/video/${id}`, videoFormData, {
                    headers: {
                        Authorization: `KEY ${logicStore.key}`,
                        "Content-Type": "multipart/form-data",
                    },
